...
/** @defgroup Acc_Full_Scale_Selection
  * @{
  */
#define LSM303C_ACC_FULLSCALE_2G            ((uint8_t)0x00)  /*!< Ѳ g */
#define LSM303C_ACC_FULLSCALE_4G            ((uint8_t)0x20)  /*!< Ѵ g */
#define LSM303C_ACC_FULLSCALE_8G            ((uint8_t)0x30)  /*!< Ѹ g */
/**
  * @}
  */
...
#define LSM303C_MAG_FS_16_GA                 ((uint8_t) 0x03 << 5)  /*!< Full scale = ѱ6 Gauss */
/**
  * @}
  */ 
